<template>
  <svg :width="width" :height="height" style="max-height:500px" viewBox="-1000 -1000 2000 2000"
    ...
    <g>
      ...
      <path id="frame" fill="#121212" d="M 0 -1000
      ...
      <g id="nav-flag" v-show="navFlag">
          ...
          <text x="235" y="-480" style="font-size:130px;fill:black;font-weight:bold;font-family:sans-serif;">N</text>
          <text x="235" y="-370" style="font-size:130px;fill:black;font-weight:bold;font-family:sans-serif;">A</text>
          <text x="237" y="-260" style="font-size:130px;fill:black;font-weight:bold;font-family:sans-serif;">V</text>
      </g>
      <g id="gs-flag" v-show="gsFlag">
          <rect x="-800" y="-300" fill="red" width="250" height="170" />
          <text x="-770" y="-175" style="font-size:130px;fill:black;font-weight:bold;font-family:sans-serif;">GS</text>
      </g>
      <g mask="url(#dialmask)">
          <rect id="nav-needle" :transform="`translate(${-navDeflection/150*800},0)`" fill="white" x="-15" y="-800" width="30" height="1600"/>
          <rect id="gs-needle" :transform="`translate(0,${-gsDeflection/150*800})`" fill="white" x="-800" y="-15" width="1600" height="30"/>
      </g>
    </g>
  </svg>
</template>
...
export default {
  ...
  computed: {
    navDeflection: function() {
      return this.navCurrent < -150 ? -150 : this.navCurrent > 150 ? 150 : this.navCurrent
    },
    gsDeflection: function() {
      return this.gsCurrent < -150 ? -150 : this.gsCurrent > 150 ? 150 : this.gsCurrent
    }
  }
};
</script>
